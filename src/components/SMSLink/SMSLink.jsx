...
import styles from "./SMSLink.module.scss";
    ...
    <div className={styles.main}>
      <div className={styles.container}>
        ...
        <div className={styles.downAppLogo}>
          <div>
            <a href="https://apps.apple.com/ru/app/edonish/id1579282546">
              {" "}
              <img src={ios} alt="ios" />
            </a>
            <a href="https://play.google.com/store/apps/details?id=tj.edonish&hl=ru&gl=US">
